...
private:
    ...
    TypedImage diffusemap_;         // diffuse color texture
    TypedImage normalmap_;          // normal map texture
    TypedImage specularmap_;        // specular map texture
    void load_texture(const std::string filename, const std::string suffix, TypedImage &img);
public:
