	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_D3DTEST_SELF, g_szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_D3DTEST_SELF));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_D3DTEST_SELF));
